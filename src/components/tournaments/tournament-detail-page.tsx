...
export function TournamentDetailPageClient({ tournament }: { tournament: Tournament }) {
  const router = useRouter();
  const { players, matches, registerTeamForTournament, isAdmin, startTournament, closeTournament, calculatePointsTable } = useAppContext();
